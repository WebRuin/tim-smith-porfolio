...
(function() {
  var ImageZoom = function(element) {
    ...
    this.lightbox = this.element.getElementsByClassName(
      'js-image-zoom__lightbox'
    )[0];
  ...
  function initImageZoomHtml(imageZoom) {
    ...
    var newHtml =
      '<div class="image-zoom__lightbox js-image-zoom__lightbox" aria-hidden="true"><img src="' +
      url +
      '" class="js-image-zoom__fw"></img></div><input aria-hidden="true" type="checkbox" class="image-zoom__input js-image-zoom__input"></input>';
